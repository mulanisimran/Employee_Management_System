	   ...
	   JTextField textField_4 = new JTextField();
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String sql="insert into emp_data(EmpID,firstName,surName,Age) values (?,?,?,?)";
					pst=connection.prepareStatement(sql);
		...
		btnUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    String sql="update emp_data set firstName='"+value2+"',surName='"+value3+"',Age='"+value4+"' where EmpID='"+value1+"'";
				...
				String sql1="select * from emp_data";
				Statement st=connection.createStatement();
				pst.setString(4,textField_3.getText());
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(p==0) {
					String sql="delete from emp_data where EmpID=?";
